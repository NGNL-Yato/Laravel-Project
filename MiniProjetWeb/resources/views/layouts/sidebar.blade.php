...
{{-- 
      <ul>
        <li>
          <a href="#emploi" data-id="emploi" title="emploi" class="tooltip">
        ...
        <li>
          <a href="#announces" data-id="announces" title="announces" class="tooltip">
        ...
        <li>
          <a href="#demande" data-id="demande" title="Industries" class="tooltip">
    ...
    <div class="sidebar__profile">
      ...
      <a class="loga logout hide" href="{{ route('logout') }}"
