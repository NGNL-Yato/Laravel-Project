                    ...
                    <div class="container">
                        <table style="width: 100%; border-collapse: collapse;">
                            <tr style="background-color: #f2f2f2;">
                                ...
                                <th style="padding: 10px; border: 1px solid #ddd;">Competence Debouche</th>
                                <th style="padding: 10px; border: 1px solid #ddd;">Filiere Name</th>
                            </tr>
                            @foreach($descriptionFormation as $description)
                                <tr>
                                    <td style="padding: 10px; border: 1px solid #ddd;">{{ $description->objectif_text }}</td>
                                    <td style="padding: 10px; border: 1px solid #ddd;">{{ $description->competence_debouche }}</td>
                        ...
                        @foreach($filiere as $f)
                            <div style="display: flex; align-items: center; margin-top: 10px;">
                                <img src="{{URL('assets/email.png')}}" alt="Email Icon" style="margin-right: 10px; width: 30px; height: 30px;">
                                <p>{{ $f->professeur->user->email }}</p>
                                <span style="margin: 0 10px;">|</span>
                                <p>{{ $f->professeur->nom }}</p>
                                <span style="margin: 0 10px;">|</span>
                                <p>{{ $f->professeur->prenom }}</p>
                            </div>
                        @endforeach
                    </div>
                </section>
