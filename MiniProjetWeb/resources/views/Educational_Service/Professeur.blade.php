...
<div class="container">
    <div class="professeurs_div educational_service-center">
        ...
        <table class="table">
            <thead class="table__thead">
                <tr>
                    <th class="table__th">Code Prof</th>
                    <th class="table__th">Nom</th>
                    <th class="table__th">Prenom</th>
            ...
            <tbody class="table__tbody">
                @foreach($professeurs as $professeur)
                    <tr class="table-row table-row--chris">
                        <td class="table-row__td">{{ $professeur->Code_prof }}</td>
                        <td class="table-row__td">{{ $professeur->nom }}</td>
                        <td class="table-row__td">{{ $professeur->prenom }}</td>
                        <td class="table-row__td">{{ $professeur->id_user }}</td>
                        <td class="table-row__td action-td">
                            ...
                            <button class="editButton" 
                                    ...
                                    data-id-user="{{ $professeur->id_user }}">
