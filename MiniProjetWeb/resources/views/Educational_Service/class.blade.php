...
<div class="container">
            ...
            <button id="showCreateClasseForm" style="margin: 1rem 0;">Add New Classe</button>
    <div class="classe_div educational_service-center">
        ...
        <table class="table">
            <thead class="table__thead">
                <tr>
                    <th class="table__th">Numero_groupe</th>
            ...
            <tbody class="table__tbody">
                ...
                <tr class="table-row">
                    ...
                    <td class="table-row__td">
                        <button href="{{ route('emploidutemps.index', $classe->id) }}">Emploi du temps</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
