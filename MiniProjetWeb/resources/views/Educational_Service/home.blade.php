...
<li>
  ...
  <li>
    <a href="{{URL('Educational_Service/annonces')}}" data-id="emploi" title="emploi" class="tooltip">
  ...
  <li>
    <a href="{{URL('Educational_Service/emploidutemps')}}" data-id="emploi" title="emploi" class="tooltip">
  ...
  <li>
    <a href="{{URL('Educational_Service/Demande')}}" data-id="emploi" title="emploi" class="tooltip">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-layout-dashboard" width="24"
        height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
        stroke-linejoin="round" aria-hidden="true">
        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
  ...
  <li>
    <a href="{{URL('Educational_Service/Reponse')}}" data-id="emploi" title="emploi" class="tooltip">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-layout-dashboard" width="24"
        height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
        stroke-linejoin="round" aria-hidden="true">
        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
      ...
      <span class="link hide">Reponses</span>
    </a>
  </li> 
@endsection
